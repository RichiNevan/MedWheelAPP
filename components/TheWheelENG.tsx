      ...
      <Svg style={styles.svg}>
        ...
        >
          ...
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath fill="black" href="#estacoes" startOffset={hemisphere === 'north'? '7%' : '82%'}>
              WINTER
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath fill="white" href="#estacoes" startOffset={hemisphere === 'north'? '30.5%' : '56%'}>
              AUTUMN
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath fill="black" href="#estacoes" startOffset={hemisphere === 'north'? '56%' : '31%'}>
              SUMMER
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath fill="black" href="#estacoes" startOffset={hemisphere === 'north'? '82%' : '7.5%'}>
              SPRING
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath fill="black" href="#elementos" startOffset={hemisphere === 'north'? '9%' : '84%'}>
              AIR
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath fill="white" href="#elementos" startOffset={hemisphere === 'north'? '30%' : '55.5%'}>
              EARTH
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath fill="black" href="#elementos" startOffset={hemisphere === 'north'? '55%' : '30%'}>
              WATER
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath fill="black" href="#elementos" startOffset={hemisphere === 'north'? '82.5%' : '8.5%'}>
              FIRE
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath fill="black" href="#corpos" startOffset={hemisphere === 'north'? '5%' : '79%'}>
              MENTAL BODY
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath fill="white" href="#corpos" startOffset={hemisphere === 'north'? '28.5%' : '53.5%'}>
              PHYSICAL BODY
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath fill="black" href="#corpos" startOffset={hemisphere === 'north'? '52%' : '27.5%'}>
              EMOTIONAL BODY
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath fill="black" href="#corpos" startOffset={hemisphere === 'north'? '78%' : '3.5%'}>
              SPIRITUAL BODY
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath fill="black" href="#reinos" startOffset={hemisphere === 'north'? '6%' : '80.2%'}>
              ANIMAL REALM
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath fill="white" href="#reinos" startOffset={hemisphere === 'north'? '30%' : '55%'}>
              MINERAL REALM
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath fill="black" href="#reinos" startOffset={hemisphere === 'north'? '54.5%' : '30%'}>
              VEGETAL REALM
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath fill="black" href="#reinos" startOffset={hemisphere === 'north'? '79.5%' : '4.5%'}>
              SPIRITUAL REALM
            </TextPath>
          </Text>
          <Text fontSize="13" fontFamily="CocchinBold">
            <TextPath fill="black" href="#spirits" startOffset={hemisphere === 'north'? '7%' : '82%'}>
              WABOOSE
            </TextPath>
          </Text>
          <Text fontSize="13" fontFamily="CocchinBold" >
            <TextPath fill="white" href="#spirits" startOffset={hemisphere === 'north'? '28.5%' : '54.5%'}>
              MUDJEKEEWIS
            </TextPath>
          </Text>
          <Text fontSize="13" fontFamily="CocchinBold" >
            <TextPath fill="black" href="#spirits" startOffset={hemisphere === 'north'? '54.5%' : '30%'}>
              SHAWNODESE
            </TextPath>
          </Text>
          <Text fontSize="13" fontFamily="CocchinBold" >
            <TextPath fill="black" href="#spirits" startOffset={hemisphere === 'north'? '83.5%' : '8%'}>
              WABUN
            </TextPath>
          </Text>
          <Circle
          ...
          <Text fontSize="9" fontFamily="Cocchin" >
            <TextPath fill="black" href="#moontexts" startOffset={(hemisphere === 'north') ? "20%" : '73.9%'}>
              Renovation
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontextsLuada" startOffset={(hemisphere === 'north') ? "20.5%" : '74.4%'}>
            Moon of
            </TextPath>
          </Text>

          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontexts" startOffset={(hemisphere === 'north') ? "12.6%" : '82%'}>
              Cleansing
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontextsLuada" startOffset={(hemisphere === 'north') ? "13%" : '82.3%'}>
            Moon of
            </TextPath>
          </Text>
          ...
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontexts" startOffset={(hemisphere === 'north') ? "3.9%" : '89.7%'}>
              Strong Winds
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontextsLuada" startOffset={(hemisphere === 'north') ? "4.9%" : '90.5%'}>
            Moon of
            </TextPath>
          </Text>

          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontexts" startOffset={(hemisphere === 'north') ? "96.1%" : '1.1%'}>
              Beginnings
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontextsLuados" startOffset={(hemisphere === 'north') ? "96.7%" : '1.6%'}>
            Moon of
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontextsLuada" startOffset={(hemisphere === 'north') ? "97.4%" : '2.5%'}>
             new
            </TextPath>
          </Text>

          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontexts" startOffset={(hemisphere === 'north') ? "89%" : '9.9%'}>
              Growth
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontextsLuada" startOffset={(hemisphere === 'north') ? "88.9%" : '9.9%'}>
            Moon of
            </TextPath>
          </Text>

          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontexts" startOffset={(hemisphere === 'north') ? "80.3%" : '17.8%'}>
              Florishing
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontextsLuada" startOffset={(hemisphere === 'north') ? "80.6%" : '18.2%'}>
            Moon of
            </TextPath>
          </Text>

          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontexts" startOffset={(hemisphere === 'north') ? "72.2%": '25.9%'}>
              Long Days
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontextsLuada" startOffset={(hemisphere === 'north') ? "72.5%" : '26.5%'}>
            Moon of
            </TextPath>
          </Text>

          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontexts" startOffset={(hemisphere === 'north') ? "64.6%" : '34%'}>
              Ripening
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontextsLuada" startOffset={(hemisphere === 'north') ? "64.7%" : '34.3%'}>
            Moon of
            </TextPath>
          </Text>

          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontexts" startOffset={(hemisphere === 'north') ? "56.1%" : '41.6%'}>
              Abundance
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontextsLuada" startOffset={(hemisphere === 'north') ? "56.8%" : '42.3%'}>
            Moon of
            </TextPath>
          </Text>

          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontexts" startOffset={(hemisphere === 'north') ? "44%" : '49.3%'}>
              Falling Leaves
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontextsLuada" startOffset={(hemisphere === 'north') ? "45.3%" : '50.5%'}>
            Moon of
            </TextPath>
          </Text>
          ...
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontextsLuada" startOffset={(hemisphere === 'north') ? "37%" : '58.4%'}>
             Moon of
            </TextPath>
          </Text>

          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontexts" startOffset={(hemisphere === 'north') ? "27.8%" : '65.8%'}>
              Long Nights
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath fill="black" href="#moontextsLuada" startOffset={(hemisphere === 'north') ? "28.7%" : '66.3%'}>
             Moon of 
            </TextPath>
          </Text>
        </G>
