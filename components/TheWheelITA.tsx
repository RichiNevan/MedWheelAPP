        ...
        >
          ...
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#estacoes"
              startOffset={hemisphere === "north" ? "6%" : "81.4%"}
            >
              INVERNO
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath
              fill="white"
              href="#estacoes"
              startOffset={hemisphere === "north" ? "30.5%" : "55.7%"}
            >
              AUTUNNO
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#estacoes"
              startOffset={hemisphere === "north" ? "57.6%" : "32%"}
            >
              ESTATE
            </TextPath>
          </Text>
          ...
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#elementos"
              startOffset={hemisphere === "north" ? "7.8%" : "83.5%"}
            >
              ARIA
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath
              fill="white"
              href="#elementos"
              startOffset={hemisphere === "north" ? "30.7%" : "55.9%"}
            >
              TERRA
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#elementos"
              startOffset={hemisphere === "north" ? "55.7%" : "30.2%"}
            >
              ACQUA
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#elementos"
              startOffset={hemisphere === "north" ? "80.5%" : "5.1%"}
            >
              FUOCO
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#corpos"
              startOffset={hemisphere === "north" ? "3%" : "78.2%"}
            >
              CORPO MENTALE
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath
              fill="white"
              href="#corpos"
              startOffset={hemisphere === "north" ? "29.6%" : "55.1%"}
            >
              CORPO FISICO
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#corpos"
              startOffset={hemisphere === "north" ? "50.8%" : "25.8%"}
            >
              CORPO EMOZIONALE
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#corpos"
              startOffset={hemisphere === "north" ? "76.8%" : "2%"}
            >
              CORPO SPIRITUALE
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#reinos"
              startOffset={hemisphere === "north" ? "4.8%" : "80.2%"}
            >
              REGNO ANIMALE
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath
              fill="white"
              href="#reinos"
              startOffset={hemisphere === "north" ? "29%" : "54.2%"}
            >
              REGNO MINERALE
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#reinos"
              startOffset={hemisphere === "north" ? "54.2%" : "29.6%"}
            >
              REGNO VEGETALE
            </TextPath>
          </Text>
          <Text fontSize="9" fontWeight="400" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#reinos"
              startOffset={hemisphere === "north" ? "79.1%" : "3.4%"}
            >
              REGNO SPIRITUALE
            </TextPath>
          </Text>
          <Text fontSize="13" fontFamily="CocchinBold">
            <TextPath
              fill="black"
              href="#spirits"
              startOffset={hemisphere === "north" ? "6.8%" : "82.7%"}
            >
              WABOOSE
            </TextPath>
          </Text>
          <Text fontSize="13" fontFamily="CocchinBold">
            <TextPath
              fill="white"
              href="#spirits"
              startOffset={hemisphere === "north" ? "29.4%" : "54.5%"}
            >
              MUDJEKEEWIS
            </TextPath>
          </Text>
          <Text fontSize="13" fontFamily="CocchinBold">
            <TextPath
              fill="black"
              href="#spirits"
              startOffset={hemisphere === "north" ? "54.9%" : "30.2%"}
            >
              SHAWNODESE
            </TextPath>
          </Text>
          <Text fontSize="13" fontFamily="CocchinBold">
            <TextPath
              fill="black"
              href="#spirits"
              startOffset={hemisphere === "north" ? "84.3%" : "7.7%"}
            >
              WABUN
            </TextPath>
          </Text>
          ...
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontexts"
              startOffset={hemisphere === "north" ? "19.4%" : "73.4%"}
            >
              Rinnovamento
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontextsLuada"
              startOffset={hemisphere === "north" ? "20.5%" : "74.3%"}
            >
              Luna del
            </TextPath>
          </Text>
          ...
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontexts"
              startOffset={hemisphere === "north" ? "13%" : "82.7%"}
            >
              Pulizia
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontextsLuada"
              startOffset={hemisphere === "north" ? "12.8%" : "82.2%"}
            >
              Lua della
            </TextPath>
          </Text>
          ...
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontexts"
              startOffset={hemisphere === "north" ? "4%" : "90%"}
            >
              Venti Forti
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontextsLuada"
              startOffset={hemisphere === "north" ? "4.6%" : "90.5%"}
            >
              Luna dei
            </TextPath>
          </Text>
          ...
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontexts"
              startOffset={hemisphere === "north" ? "97.5%" : "2.4%"}
            >
              Inizi
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              ...
              startOffset={hemisphere === "north" ? "96.8%" : "1.9%"}
            >
              Luna dei
            </TextPath>
          </Text>
          ...
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontexts"
              startOffset={hemisphere === "north" ? "88.9%" : "10%"}
            >
              Crescita
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontextsLuada"
              startOffset={hemisphere === "north" ? "88.5%" : "9.8%"}
            >
              Luna della
            </TextPath>
          </Text>
          ...
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontexts"
              startOffset={hemisphere === "north" ? "80.5%" : "18.1%"}
            >
              Fioritura
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontextsLuada"
              startOffset={hemisphere === "north" ? "80.2%" : "17.9%"}
            >
              Luna della
            </TextPath>
          </Text>
          ...
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontexts"
              startOffset={hemisphere === "north" ? "71.3%" : "25%"}
            >
              Lunghe Giornate
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontextsLuada"
              startOffset={hemisphere === "north" ? "72.3%" : "26.2%"}
            >
              Luna delle
            </TextPath>
          </Text>
          ...
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontexts"
              startOffset={hemisphere === "north" ? "63.9%" : "33.5%"}
            >
              Maturazione
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontextsLuada"
              startOffset={hemisphere === "north" ? "64.3%" : "34.2%"}
            >
              Luna della
            </TextPath>
          </Text>
          ...
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontexts"
              startOffset={hemisphere === "north" ? "55.9%" : "41.6%"}
            >
              Abbondanza
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontextsLuada"
              startOffset={hemisphere === "north" ? "56.5%" : "42.3%"}
            >
              Luna dell'
            </TextPath>
          </Text>
          ...
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontexts"
              startOffset={hemisphere === "north" ? "43.4%" : "48.8%"}
            >
              Cadere delle Foglie
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontextsLuada"
              startOffset={hemisphere === "north" ? "45.2%" : "50.3%"}
            >
              Luna del
            </TextPath>
          </Text>
          ...
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontexts"
              startOffset={hemisphere === "north" ? "35.7%" : "57%"}
            >
              Decomposizione
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontextsLuada"
              startOffset={hemisphere === "north" ? "37%" : "58%"}
            >
              Luna della
            </TextPath>
          </Text>
          ...
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontexts"
              startOffset={hemisphere === "north" ? "27.7%" : "65.6%"}
            >
              Lunghe Notti
            </TextPath>
          </Text>
          <Text fontSize="9" fontFamily="Cocchin">
            <TextPath
              fill="black"
              href="#moontextsLuada"
              startOffset={hemisphere === "north" ? "28.4%" : "66.2%"}
            >
              Luna delle
            </TextPath>
          </Text>
